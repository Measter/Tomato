namespace Lettuce
{
    partial class HardwareConfiguration
    {
        ...
        private void InitializeComponent()
        {
			...
			this.availableListBox.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.availableListBox_MouseDoubleClick);
			// 
			// addDeviceButton
			// 
			...
			this.selectedListBox.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.selectedListBox_MouseDoubleClick);
			// 
			// moveUpButton
			// 
